...
class PredictionService {
  ...
  static Future<Map<String, dynamic>> predict({
    ...
    final url = Uri.parse("$baseUrl/predict-and-decide");
  ...
  static Future<Map<String, dynamic>> getDropdownData() async {
    final response = await http.get(Uri.parse("$baseUrl/dropdown-data"));
  ...
  static Future<Map<String, dynamic>> getProductStoreInfo({
    required String productId,
    required String storeId,
  }) async {
